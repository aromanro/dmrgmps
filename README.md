...
I also used Chat GPT 5.5 to check the code and I also checked the code myself, although not all details. Some of the tests are added/modified by me, I also had to remove or change portions of the old code and I had to change quite a bit of the new code because there was a lot of switching between tensors and matrices... some of the computations that could be done with tensor contractions were done by slicing and operating with matrices.
