...
void CDmrgPropertyPage::DoDataExchange(CDataExchange* pDX)
{
	...
	DDV_MinMaxInt(pDX, states, 10, 100);
	DDV_MinMaxInt(pDX, sweeps, 1, 30);
...
BEGIN_MESSAGE_MAP(CDmrgPropertyPage, CMFCPropertyPage)
	...
	ON_CBN_SELCHANGE(IDC_COMBO1, &CDmrgPropertyPage::OnCbnSelchangeCombo1)
END_MESSAGE_MAP()
...
void CDmrgPropertyPage::OnCbnSelchangeCombo1()
{
	SetModified();
}
